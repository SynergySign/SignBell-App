...
export const useWaitingRoomJanus = ({
  ...
  }, [myUserId, participants.length, roomId, isWebcamOn, stream, janusRef, pluginHandleRef, remoteFeedsRef, userIdToFeedIdRef, setIsJanusConnected, setRemoteStreams, isNavigatingToGameRef]);
